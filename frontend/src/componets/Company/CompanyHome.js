...
class MainHome extends Component {
  ...
  componentDidMount = async () => {
    ...
    try {
      const res = await axios.get(
        `http://localhost:5000/api/v1/category/${sessionStorage.getItem(
          "cat"
        )}/complaint`,
        config
      );
  ...
  render() {
    return (
      <Fragment>
        <section className="counts section2 mt-5">
              ...
              {this.state.categories.map((cat) => (
                ...
                >
                  <div className="product-top">
                    <img src={`${cat.photo}`} className="img1" alt="" />
                    <div className="product-bottom text-center">
                      <h3 className="text-dark1">{cat.title}</h3>
                      <h3 className="text-dark1">{cat.department.catname}</h3>
                      <h4 className="text-dark1">{cat.ward}</h4>
                      <h4 className="text-dark1">{cat.issue}</h4>
                      <Link
                        type="submit"
