...
export default class ShowDonors extends Component {
  ...
  onDeleteUser = async (id, e) => {
    ...
    try {
      await axios.delete(
        `http://localhost:5000/api/v1/complaint/${id}`,
        config
      );
          ...
          <div id="portfolio">
            <div className="container showtop  login-second ">
              <div className="page-title text-center">
                <h1 className="text-dark">Complaints</h1>
                    ...
                    <div className="well">
                      ...
                      <table className="table table-hover">
                        <tr>
                          ...
                          <th>
                            {" "}
                            <label className="text-dark">Complaints </label>
                          </th>
                          <th>
                            {" "}
                          ...
                          <th>
                            {" "}
                            <label className="text-dark">Ward</label>
                          </th>
                        ...
                        {this.state.complaint.map((comp) => (
                          <tr>
                            ...
                            <td className="tbld text-dark">{comp.title}</td>
                            <td className="tbld text-dark">
                              {comp.department.catname}
                            </td>
                            <td className="tbld text-dark">{comp.address}</td>
                            <td className="tbld text-dark">{comp.ward}</td>
